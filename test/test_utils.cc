/****************** -*- Mode: C++; Indent: Inktomi4 -*- *********************
   ...
   $Id: test_utils.cc,v 1.2 2003-06-01 18:38:30 re1 Exp $
...
static const char* backup_to_next_dot(const char* start, const char* end) {
...
char* get_arch_str() {
    ...
    uname(&uname_info);
    if (strcmp(uname_info.sysname, "SunOS") == 0 &&
	strcmp(uname_info.machine, "i86pc") == 0) {
