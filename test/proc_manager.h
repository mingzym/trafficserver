/****************** -*- Mode: C++; Indent: Inktomi4 -*- *********************
   ...
   $Id: proc_manager.h,v 1.2 2003-06-01 18:38:29 re1 Exp $
...
class NetCmdHandler : public SioRafServer {
  ...
  private:
    ...
    void output_query_process_info(ProcRecord* pr, const char* q_proc_value,
				   RafCmd* raf_resp, int* next_index);
...
class InstallerSendInput : public FD_Handler {
  public:
    ...
    void start_send(InstallerHandler* master_arg,
