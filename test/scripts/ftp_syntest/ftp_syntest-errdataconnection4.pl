#
#  ftp_syntest-errdataconnection.pl
#
#    Run the default ftp_syntest testing suite against Traffic Server
#
#
#  $Id: ftp_syntest-errdataconnection4.pl,v 1.2 2003-06-01 18:38:33 re1 Exp $
#
...
proxy.config.ftp.client_ctrl_no_activity_timeout	10
proxy.config.ftp.client_ctrl_active_timeout		10
proxy.config.ftp.server_ctrl_no_activity_timeout	10
proxy.config.ftp.server_ctrl_active_timeout		10
proxy.config.ftp.client_data_no_activity_timeout	10
proxy.config.ftp.client_data_active_timeout		10
proxy.config.ftp.server_data_no_activity_timeout	10
proxy.config.ftp.server_data_active_timeout		10
proxy.config.ftp.pasv_accept_timeout			10
proxy.config.ftp.port_accept_timeout			10
...
@ftp_syntest_client_start_args =
    ("args", "-f errdataconnection.xml -d . -c XFER_NonAnonymous");
