...
#  Author: bevans
#
#  $Id: ldap-auzn.pl,v 1.2 2003-06-01 18:38:31 re1 Exp $
#
...
my $CVS_ID_TAG   = '$Id: ldap-auzn.pl,v 1.2 2003-06-01 18:38:31 re1 Exp $';
...
$cfg->set_debug_tags ('http_auth|http_hdrs|deft.*|ldap.*');
...
$pcfg->ACL_ALL(
	       ...
	       auzn => "LDAP",
	       ruleData => 
	          $pcfg->RULE_DATA(["add-req-header", 
			       "X-Deft-Validation: ldap-auzn"])
	       );
...
our @syntest_start_args = 
    ("args", "-f ldap_tests.cfg -c ACC-LDAP-Group-Auth -noquit");
