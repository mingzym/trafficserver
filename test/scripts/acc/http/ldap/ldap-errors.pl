...
#  Author: bevans
#
#  $Id: ldap-errors.pl,v 1.2 2003-06-01 18:38:31 re1 Exp $
#
...
our $TEST_GROUP  = "ACC-LDAP-Errors-1";
...
my $CVS_ID_TAG   = '$Id: ldap-errors.pl,v 1.2 2003-06-01 18:38:31 re1 Exp $';
...
$cfg->set_debug_tags ('http_auth|ldap.*|deft_ldap');
...
our @syntest_start_args = 
    ("args", "-f ldap_tests.cfg -c $TEST_GROUP -noquit");
