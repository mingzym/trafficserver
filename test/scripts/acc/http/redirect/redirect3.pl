...
#
#
#  $Id: redirect3.pl,v 1.2 2003-06-01 18:38:32 re1 Exp $
#
...
proxy.config.ldap.proc.ldap.server.name  localhost
...
@http_syntest_start_args = ("args","-f redirect.cfg -c Fatal1");
