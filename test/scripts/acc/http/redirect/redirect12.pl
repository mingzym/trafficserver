#
#  redirect12.pl (reverse proxy)
#
#    Run the default syntest testing suite against Traffic Server
#
#
#  $Id: redirect12.pl,v 1.2 2003-06-01 18:38:32 re1 Exp $
#
...
proxy.config.ldap.proc.ldap.server.name  ts-nt0.tsqa.inktomi.com
...
@http_syntest_start_args =
    ("args", "-h %%(ts1) -p %%(ts1:tsHttpPort) -f redirect.cfg -c Redirect12");
