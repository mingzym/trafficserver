#
#  null_functional.pl (based on append_function by frackc)
#
#    Run functional test cases for plugin append-transform
#
#  Author: bevans
#
#  $Id: null_functional.pl,v 1.2 2003-06-01 18:38:33 re1 Exp $
#
...
$cfg->add_config_line ('null-transform.so');
...
# Install the plugin
$plg_src = "../../../../proxy/api/samples/null-transform/";
$plg_dst = "config/plugins/";
$cfg_src = "config/";
$cfg_dst = "config/plugins/";

TestExec::put_instance_file_raw
    ("ts1", $plg_dst . "null-transform.so",  
     $plg_src . "null-transform.so",);
