...
#  Author: franckc
#
#  $Id: pool_functional.pl,v 1.2 2003-06-01 18:38:33 re1 Exp $
#
...
# $cfg->set_debug_tags ('pool.*');
$cfg->add_config('plugin.config');
$cfg->add_config_line ('psi.so');
...
@syntest_start_args = ("args", "-f pool_tests.cfg -c PsiPlugin -noquit");
@empty_args = ();
...
# Install the plugin
$plg_src = "../../../../proxy/api/samples/thread-pool/";
$plg_dst = "config/plugins/";
$cfg_src = "config/";
$cfg_dst = "config/plugins/";
TestExec::put_instance_file_raw("ts1", $plg_dst . "psi.so", $plg_src . "psi.so",);
...
# Install
TestExec::put_instance_file_raw("syntest1", "pool_tests.cfg", "pool_tests.cfg");
TestExec::put_instance_file_raw("syntest1", "pool_syntest.tar", "pool_syntest.tar");
