/****************** -*- Mode: C++; Indent: Inktomi4 -*- *********************
   ...
   $Id: test_log_collate.cc,v 1.2 2003-06-01 18:38:30 re1 Exp $
...
void LogAcceptHandler::start(int port) {
...
void LogAcceptHandler::handle_accept(s_event_t event, void* data) {
...
int LogCollateHandler::active_loggers = 0;
...
void LogCollateHandler::dispatcher() {
...
void LogCollateHandler::process_cmd_log_roll() {
...
void LogCollateHandler::process_cmd_shutdown() {
...
void LogCollateHandler::wait_for_shutdown_complete(s_event_t event, void* data) {
...
void LogCollateHandler::response_complete() {
...
void LogCollateHandler::handle_log_input(s_event_t event, void* data) {
