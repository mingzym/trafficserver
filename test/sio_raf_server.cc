/****************** -*- Mode: C++; Indent: Inktomi4 -*- *********************
   ...
   $Id: sio_raf_server.cc,v 1.2 2003-06-01 18:38:29 re1 Exp $
...
void SioRafServer::start(int new_fd) {
...
void SioRafServer::handle_read_cmd(s_event_t event, void* data) {
...
void SioRafServer::process_cmd(char* end) {
...
void SioRafServer::send_raf_resp(RafCmd* reply) {

    Debug("raf_server", "Sending raf response %s %s %s",
...
void SioRafServer::send_raf_resp(RafCmd* cmd, int result_code, 
				  const char* msg_fmt, ...) {
